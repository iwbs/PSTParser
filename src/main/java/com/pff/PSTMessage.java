...
//	}
	...
	public String getReceivedByEmail() {
		return this.getStringItem(0x800d);
	}
	
	public String getPidTagRecipientSenderSMTPAddress() {
		return this.getStringItem(0x5d01);
	}
	...
	public HashMap<Integer, PSTDescriptorItem> getLocalDescriptorItems() {
		return localDescriptorItems;
	}
